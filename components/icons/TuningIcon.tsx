export const TuningIcon = () => (
	<svg width='20px' height='20px' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
		...
		<path
			...
			strokeLinecap='round'
		/>
		<path d='M17 11.0001L17 6.0001M17 3.00002L17 2' stroke='#f8f8f8' strokeWidth='1.5' strokeLinecap='round' />
		<path d='M17 22L17 18' stroke='#f8f8f8' strokeWidth='1.5' strokeLinecap='round' />
		<path d='M7 2L7 6' stroke='#f8f8f8' strokeWidth='1.5' strokeLinecap='round' />
	</svg>
);
